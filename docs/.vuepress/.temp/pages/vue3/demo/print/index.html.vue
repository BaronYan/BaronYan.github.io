<template><div><ul>
<li><RouteLink to="/vue3/demo/print/print1.html">打印demo 1</RouteLink></li>
<li><RouteLink to="/vue3/demo/print/print2.html">打印demo 2</RouteLink></li>
<li><RouteLink to="/vue3/demo/print/print3.html">打印demo 3</RouteLink></li>
</ul>
<h2 id="打印功能的原理" tabindex="-1"><a class="header-anchor" href="#打印功能的原理"><span>打印功能的原理</span></a></h2>
<p>当然,我很乐意为您详细介绍打印功能的原理。在我们的系统中,打印功能主要通过以下步骤实现:</p>
<h3 id="_1-创建新窗口" tabindex="-1"><a class="header-anchor" href="#_1-创建新窗口"><span>1. 创建新窗口</span></a></h3>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line"><span class="token keyword">const</span> printWindow <span class="token operator">=</span> window<span class="token punctuation">.</span><span class="token function">open</span><span class="token punctuation">(</span><span class="token string">''</span><span class="token punctuation">,</span> <span class="token string">'_blank'</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>这行代码打开一个新的浏览器窗口或标签。新窗口最初是空白的,我们将在其中插入要打印的内容。</p>
<h3 id="_2-设置打印样式" tabindex="-1"><a class="header-anchor" href="#_2-设置打印样式"><span>2. 设置打印样式</span></a></h3>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line">printWindow<span class="token punctuation">.</span>document<span class="token punctuation">.</span><span class="token function">write</span><span class="token punctuation">(</span><span class="token string">'&lt;style>'</span><span class="token punctuation">)</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里我们向新窗口写入自定义的CSS样式。这些样式定义了打印时的页面布局、尺寸等。</p>
<h3 id="_3-生成打印内容" tabindex="-1"><a class="header-anchor" href="#_3-生成打印内容"><span>3. 生成打印内容</span></a></h3>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line"><span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">let</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> quantity<span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<h3 id="_4-生成条形码" tabindex="-1"><a class="header-anchor" href="#_4-生成条形码"><span>4. 生成条形码</span></a></h3>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line">printWindow<span class="token punctuation">.</span><span class="token function-variable function">onload</span> <span class="token operator">=</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在新窗口加载完成后,我们使用JsBarcode库为每个标签生成条形码。</p>
<h3 id="_5-触发打印" tabindex="-1"><a class="header-anchor" href="#_5-触发打印"><span>5. 触发打印</span></a></h3>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line"><span class="token function">setTimeout</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>我们使用setTimeout来确保所有内容(包括条形码)都已经渲染完成,然后调用print()方法触发浏览器的打印对话框。打印完成后,我们关闭新窗口。</p>
<p>这种方法的优点包括:</p>
<ul>
<li>隔离性: 打印内容在新窗口中生成,不会影响主应用程序的状态或显示。</li>
<li>灵活性: 我们可以完全控制打印内容的样式和布局。</li>
<li>多页打印: 可以轻松生成多个标签或多页内容。</li>
<li>浏览器兼容性: 这种方法在大多数现代浏览器中都能很好地工作。</li>
</ul>
<p>需要注意的是,这种方法可能会被某些浏览器的弹出窗口拦截器阻止。在实际应用中,可能需要提醒用户允许弹出窗口,或考虑使用内嵌iframe的替代方案。</p>
<h2 id="内嵌的-iframe" tabindex="-1"><a class="header-anchor" href="#内嵌的-iframe"><span>内嵌的 iframe</span></a></h2>
<p>此外,打印的最终效果可能会受到用户的打印机设置和浏览器打印预览功能的影响。因此,在开发过程中,经常进行实际的打印测试是很重要的。</p>
<p><RouteLink to="/vue3/demo/print/print3.html">printDirectly</RouteLink> 方法确实使用了内嵌的 iframe 作为替代方案。这是一个很好的观察。让我们详细解释一下 <code v-pre>printDirectly</code> 方法的工作原理：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line"><span class="token keyword">export</span> <span class="token keyword">function</span> <span class="token function">printDirectly</span><span class="token punctuation">(</span><span class="token parameter"><span class="token punctuation">{</span> quantity<span class="token punctuation">,</span> startNumber<span class="token punctuation">,</span> labelData<span class="token punctuation">,</span> labelType<span class="token punctuation">,</span> customWidth<span class="token punctuation">,</span> customHeight<span class="token punctuation">,</span> generateBarcode<span class="token punctuation">,</span> getLabelContent <span class="token operator">=</span> getExpressLabelContent<span class="token punctuation">,</span> title <span class="token punctuation">}</span></span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个方法的主要特点和优势包括：</p>
<h3 id="_1-用内嵌-iframe" tabindex="-1"><a class="header-anchor" href="#_1-用内嵌-iframe"><span>1. 用内嵌 iframe</span></a></h3>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line"><span class="token keyword">const</span> iframe <span class="token operator">=</span> document<span class="token punctuation">.</span><span class="token function">createElement</span><span class="token punctuation">(</span><span class="token string">'iframe'</span><span class="token punctuation">)</span></span>
<span class="line">iframe<span class="token punctuation">.</span>style<span class="token punctuation">.</span>display <span class="token operator">=</span> <span class="token string">'none'</span></span>
<span class="line">document<span class="token punctuation">.</span>body<span class="token punctuation">.</span><span class="token function">appendChild</span><span class="token punctuation">(</span>iframe<span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>创建一个隐藏的 iframe 并添加到当前文档中,而不是打开新窗口。</p>
<h3 id="_2-避免弹出窗口拦截" tabindex="-1"><a class="header-anchor" href="#_2-避免弹出窗口拦截"><span>2. 避免弹出窗口拦截</span></a></h3>
<p>由于使用内嵌 iframe,不会触发浏览器的弹出窗口拦截机制。</p>
<h3 id="_3-更好的集成" tabindex="-1"><a class="header-anchor" href="#_3-更好的集成"><span>3. 更好的集成</span></a></h3>
<p>iframe 是当前页面的一部分,可以更好地控制打印过程和时机。</p>
<h3 id="_4-相似的内容生成过程" tabindex="-1"><a class="header-anchor" href="#_4-相似的内容生成过程"><span>4. 相似的内容生成过程</span></a></h3>
<p>尽管使用了 iframe,但生成打印内容的过程与 <code v-pre>openPrintWindow</code> 方法非常相似。</p>
<h3 id="_5-打印后自动移除" tabindex="-1"><a class="header-anchor" href="#_5-打印后自动移除"><span>5. 打印后自动移除</span></a></h3>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line">   <span class="token function">setTimeout</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span></span>
<span class="line">     document<span class="token punctuation">.</span>body<span class="token punctuation">.</span><span class="token function">removeChild</span><span class="token punctuation">(</span>iframe<span class="token punctuation">)</span></span>
<span class="line">   <span class="token punctuation">}</span><span class="token punctuation">,</span> <span class="token number">100</span><span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>打印完成后,iframe 会被从文档中移除,保持页面整洁。</p>
<h3 id="_6-兼容性" tabindex="-1"><a class="header-anchor" href="#_6-兼容性"><span>6. 兼容性</span></a></h3>
<p>这种方法在大多数现代浏览器中都能很好地工作,并且不受弹出窗口设置的影响。
使用内嵌 iframe 的方法确实解决了弹出窗口可能被拦截的问题,同时保持了打印功能的灵活性和可控性。这是一个很好的替代方案,特别是在需要避免弹出窗口或希望更紧密集成打印功能到现有页面的情况下。</p>
<h2 id="优化建议" tabindex="-1"><a class="header-anchor" href="#优化建议"><span>优化建议</span></a></h2>
<p>我们可以考虑一些优化方案来改进当前的打印功能。以下是一些可能的优化建议:</p>
<h3 id="使用-web-workers-生成内容" tabindex="-1"><a class="header-anchor" href="#使用-web-workers-生成内容"><span>使用 Web Workers 生成内容:</span></a></h3>
<p>对于大量标签或复杂的内容生成,我们可以将内容生成过程移到 Web Worker 中,以避免阻塞主线程。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line"><span class="token comment">// 创建一个 Web Worker</span></span>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="虚拟化长列表" tabindex="-1"><a class="header-anchor" href="#虚拟化长列表"><span>虚拟化长列表:</span></a></h3>
<p>如果需要打印大量标签,可以考虑使用虚拟滚动技术,只渲染可见区域的标签,以提高性能。</p>
<h3 id="异步加载资源" tabindex="-1"><a class="header-anchor" href="#异步加载资源"><span>异步加载资源:</span></a></h3>
<p>对于需要加载的外部资源(如字体、图片),可以使用异步加载,并在所有资源加载完成后再触发打印。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line">Promise<span class="token punctuation">.</span><span class="token function">all</span><span class="token punctuation">(</span><span class="token punctuation">[</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="缓存生成的内容" tabindex="-1"><a class="header-anchor" href="#缓存生成的内容"><span>缓存生成的内容:</span></a></h3>
<p>如果用户经常打印相同的内容,可以考虑缓存生成的 HTML 内容。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line"><span class="token keyword">const</span> contentCache <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Map</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line"></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="使用-web-components" tabindex="-1"><a class="header-anchor" href="#使用-web-components"><span>使用 Web Components:</span></a></h3>
<p>可以将标签内容封装为自定义元素,这样可以更好地控制渲染和样式隔离。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line"><span class="token keyword">class</span> <span class="token class-name">LabelElement</span> <span class="token keyword">extends</span> <span class="token class-name">HTMLElement</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="优化条形码生成" tabindex="-1"><a class="header-anchor" href="#优化条形码生成"><span>优化条形码生成:</span></a></h3>
<p>可以考虑使用 Web Assembly 版本的条形码生成库,以提高性能。</p>
<h3 id="使用-css-打印优化" tabindex="-1"><a class="header-anchor" href="#使用-css-打印优化"><span>使用 CSS 打印优化:</span></a></h3>
<p>利用 CSS 的 @page 规则和 @media print 查询来更精确地控制打印布局。</p>
<div class="language-css line-numbers-mode" data-highlighter="prismjs" data-ext="css" data-title="css"><pre v-pre class="language-css"><code><span class="line"><span class="token atrule"><span class="token rule">@page</span></span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="批量处理" tabindex="-1"><a class="header-anchor" href="#批量处理"><span>批量处理:</span></a></h3>
<p>对于大量标签,可以考虑分批生成和打印,以减少内存使用并提高响应性。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line"><span class="token keyword">function</span><span class="token operator">*</span> <span class="token function">batchGenerator</span><span class="token punctuation">(</span><span class="token parameter">total<span class="token punctuation">,</span> batchSize</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="预渲染常用内容" tabindex="-1"><a class="header-anchor" href="#预渲染常用内容"><span>预渲染常用内容</span></a></h3>
<p>对于经常使用的标签模板,可以预先渲染并存储,以加快生成速度。</p>
<h3 id="使用-service-worker" tabindex="-1"><a class="header-anchor" href="#使用-service-worker"><span>使用 Service Worker</span></a></h3>
<p>可以利用 Service Worker 来缓存打印资源,使得即使在离线状态下也能打印。</p>
<p>这些优化方案可以根据具体的使用场景和性能需求来选择实施。每种优化都有其适用的场景,建议在实施前进行性能测试,以确定哪些优化措施能带来最大的收益。</p>
</div></template>
