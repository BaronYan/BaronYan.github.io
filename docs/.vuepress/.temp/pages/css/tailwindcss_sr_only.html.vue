<template><div><h1 id="sr-only" tabindex="-1"><a class="header-anchor" href="#sr-only"><span>sr-only</span></a></h1>
<p><code v-pre>sr-only</code> 是一个常用的 CSS 类名，主要用于提高网页的可访问性（accessibility）。</p>
<p>它的全称是 &quot;screen reader only&quot;，意思是&quot;仅供屏幕阅读器使用&quot;。</p>
<p>这个类的主要作用如下：</p>
<ul>
<li><strong>隐藏视觉元素</strong>：使用 <code v-pre>sr-only</code> 类的元素在视觉上是不可见的，但仍然存在于 DOM 中。</li>
...
<p>典型的 <code v-pre>sr-only</code> CSS 实现可能如下：</p>
<div class="language-css line-numbers-mode" data-highlighter="prismjs" data-ext="css" data-title="css"><pre v-pre class="language-css"><code><span class="line"><span class="token selector">.sr-only</span> <span class="token punctuation">{</span></span>
...
<div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre v-pre class="language-html"><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>button</span><span class="token punctuation">></span></span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在这个例子中，视力正常的用户会看到一个删除图标，而使用屏幕阅读器的用户会听到&quot;删除项目&quot;这个描述，从而理解按钮的功能。</p>
<p>总之，<code v-pre>sr-only</code> 是一个重要的辅助工具，用于提高网站的可访问性，确保所有用户，包括那些依赖辅助技术的用户，都能获得良好的用户体验。</p>
</div></template>
