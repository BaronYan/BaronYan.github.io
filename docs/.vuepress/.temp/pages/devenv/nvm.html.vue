<template><div><h1 id="npm管理工具-nvm-以及-npm-换源工具-chsrc" tabindex="-1"><a class="header-anchor" href="#npm管理工具-nvm-以及-npm-换源工具-chsrc"><span>npm管理工具 nvm 以及 npm 换源工具 chsrc</span></a></h1>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="npm-换源" tabindex="-1"><a class="header-anchor" href="#npm-换源"><span>npm 换源</span></a></h2>
<p>推荐您使用C语言编写的全平台换源工具 <code v-pre>RubyMetric/chsrc</code></p>
<p>https://gitee.com/RubyMetric/chsrc</p>
<p>全平台命令行换源工具，目标支持 Linux, Windows, macOS, BSD 等尽可能多的操作系统，龙芯、飞腾、RISC-V 等尽可能多的 CPU。</p>
<p>我们使用 C99 来完成上述目标。我们并不使用 Python 或 JS 等解释语言，因为一个简单的换源工具，不应该强行塞给用户一个庞大的解释器和数十、数百 MB 其他文件。</p>
<p>chsrc 不仅是一个命令行工具，同时也是一个换源框架，它甚至使你能够在不了解C语言的情况下编写出新的换源方法(recipe)。</p>
