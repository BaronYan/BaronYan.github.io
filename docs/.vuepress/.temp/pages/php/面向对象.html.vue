<template><div><h2 id="对象" tabindex="-1"><a class="header-anchor" href="#对象"><span>对象</span></a></h2>
...
<ul>
<li><span class="bg-yellow-200">警告 PHP 保留所有以 <code v-pre>__</code> 开头的方法名称。 因此，除非覆盖 PHP 的行为，否则不建议使用此类方法名称。</span></li>
</ul>
</li>
