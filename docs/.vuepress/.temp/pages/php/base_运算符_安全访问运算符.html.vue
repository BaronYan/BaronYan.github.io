<template><div><h2 id="全访问运算符" tabindex="-1"><a class="header-anchor" href="#全访问运算符"><span>全访问运算符</span></a></h2>
...
<p><strong>安全访问运算符</strong>（<code v-pre>?-&gt;</code>）允许你在调用对象方法或访问对象属性时，
安全地处理可能为 <code v-pre>null</code> 的对象。
在链式调用中，如果某个对象为 <code v-pre>null</code>，安全访问运算符会直接返回 <code v-pre>null</code>，而不会引发错误。这简化了代码的编写，减少了显式的 <code v-pre>null</code> 检查。</p>
<h3 id="语法" tabindex="-1"><a class="header-anchor" href="#语法"><span>语法</span></a></h3>
<div class="language-php line-numbers-mode" data-highlighter="prismjs" data-ext="php" data-title="php"><pre v-pre class="language-php"><code><span class="line"><span class="token variable">$variable</span><span class="token operator">?-></span><span class="token function">method</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="工作原理" tabindex="-1"><a class="header-anchor" href="#工作原理"><span>工作原理</span></a></h3>
<p>当使用安全访问运算符时：</p>
<ul>
<li>如果 <code v-pre>$variable</code> 是一个对象，调用其方法或访问其属性。</li>
<li>如果 <code v-pre>$variable</code> 是 null，整个表达式返回 null，而不会产生错误。</li>
</ul>
<h3 id="示例" tabindex="-1"><a class="header-anchor" href="#示例"><span>示例</span></a></h3>
<div class="language-php line-numbers-mode" data-highlighter="prismjs" data-ext="php" data-title="php"><pre v-pre class="language-php"><code><span class="line"><span class="token keyword">class</span> <span class="token class-name-definition class-name">User</span> <span class="token punctuation">{</span></span>
...
<p>安全访问运算符非常适用于以下情况：</p>
<ul>
<li>避免嵌套 <code v-pre>null</code> 检查：在调用链中，如果每个对象或属性都可能为 <code v-pre>null</code>，使用安全访问运算符可以简化代码，避免嵌套的 if 语句。</li>
<li>增强代码可读性：通过减少显式的 null 检查，代码变得更加简洁和可读。</li>
</ul>
<div class="language-php line-numbers-mode" data-highlighter="prismjs" data-ext="php" data-title="php"><pre v-pre class="language-php"><code><span class="line"><span class="token comment">// Without nullsafe operator</span></span>
...
<ol>
<li><strong>只适用于对象</strong>：安全访问运算符只能用于对象。对于数组或其他类型的数据，仍需使用传统的 null 检查方法。</li>
<li><strong>慎用过度</strong>：虽然安全访问运算符简化了 null 检查，但在设计对象时，仍应尽量保证对象的完整性和一致性，避免过度依赖安全访问运算符。</li>
</ol>
<p>通过安全访问运算符，PHP 进一步增强了对空值的处理能力，使代码更加简洁和健壮。</p>
</div></template>
