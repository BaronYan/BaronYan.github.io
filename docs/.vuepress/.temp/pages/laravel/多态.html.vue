<template><div><h1 id="什么是多态关系" tabindex="-1"><a class="header-anchor" href="#什么是多态关系"><span>什么是多态关系？</span></a></h1>
<p>在 Laravel 中，<code v-pre>$table-&gt;morphs('tokenable')</code> 是一种快捷方法，用于创建多态关系的字段。
具体来说，它会在数据库表中创建两个字段：<code v-pre>tokenable_id</code> 和 <code v-pre>tokenable_type</code>，用于存储多态关系的 ID 和类型。</p>
<h2 id="多态关系简介" tabindex="-1"><a class="header-anchor" href="#多态关系简介"><span>多态关系简介</span></a></h2>
<p>多态关系允许一个模型在单个关联中属于多个其他模型。</p>
<p>例如，一个 Comment 模型可以属于 Post 模型或 Video 模型。通过多态关系，可以在同一个表中存储不同类型的关联。</p>
<h2 id="morphs-方法" tabindex="-1"><a class="header-anchor" href="#morphs-方法"><span>morphs 方法</span></a></h2>
<p><code v-pre>$table-&gt;morphs('tokenable')</code> 是 Blueprint 类中的一个方法，用于创建多态关系所需的字段。它会创建以下两个字段：</p>
<ol>
<li><code v-pre>tokenable_id</code>：存储关联模型的 ID。</li>
<li><code v-pre>tokenable_type</code>：存储关联模型的类名。</li>
</ol>
<h2 id="示例" tabindex="-1"><a class="header-anchor" href="#示例"><span>示例</span></a></h2>
<p>在你的迁移文件中，<code v-pre>$table-&gt;morphs('tokenable')</code> 用于创建 <code v-pre>personal_access_tokens</code> 表的多态关系字段。</p>
<p>以下是一个完整的示例：</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="使用多态关系" tabindex="-1"><a class="header-anchor" href="#使用多态关系"><span>使用多态关系</span></a></h2>
<p>在模型中，可以使用 morphTo 方法定义多态关系。例如：</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这样，<code v-pre>PersonalAccessToken</code> 模型就可以与多个不同类型的模型建立关联。</p>
<h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结"><span>总结：</span></a></h2>
<p><code v-pre>$table-&gt;morphs('tokenable')</code> 创建多态关系所需的字段。
它会生成 <code v-pre>tokenable_id</code> 和 <code v-pre>tokenable_type</code> 字段，用于存储关联模型的 ID 和类型。</p>
</div></template>
