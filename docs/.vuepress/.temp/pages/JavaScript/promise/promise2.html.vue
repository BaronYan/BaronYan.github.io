<template><div><h1 id="详细介绍下-promise" tabindex="-1"><a class="header-anchor" href="#详细介绍下-promise"><span>详细介绍下 Promise</span></a></h1>
...
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line"><span class="token keyword">const</span> promise <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Promise</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">resolve<span class="token punctuation">,</span> reject</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span></span>
...
<li>链式调用:Promise 可以通过 <code v-pre>.then()</code>, <code v-pre>.catch()</code>, 和 <code v-pre>.finally()</code> 方法进行链式调用。</li>
</ol>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line">promise</span>
...
<ul>
<li><code v-pre>Promise.all()</code>: 等待所有 promises 完成(或第一个失败)。</li>
<li><code v-pre>Promise.race()</code>: 等待第一个完成的 promise。</li>
<li><code v-pre>Promise.allSettled()</code>: 等待所有 promises 完成,无论成功失败。</li>
<li><code v-pre>Promise.any()</code>: 等待第一个成功的 promise。</li>
</ul>
<ol start="5">
<li>异步函数:使用 <code v-pre>async/await</code> 语法可以更简洁地处理 Promise:</li>
</ol>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line"><span class="token keyword">async</span> <span class="token keyword">function</span> <span class="token function">fetchData</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<li>错误处理:Promise 链中的错误会沿着链向下传播,直到被捕获。</li>
<li>微任务队列:Promise 的回调函数会被放入微任务队列,在当前宏任务结束后立即执行。</li>
<li>Promise 的主要优点:</li>
</ol>
<ul>
<li>改善了回调地狱问题</li>
...
<p>reject 和 resolve 是 Promise 对象中的两个重要概念。让我为您详细解释一下：</p>
<ul>
<li>resolve（解决）:
<ul>
<li>代表 Promise 成功完成。</li>
<li>当调用 <code v-pre>resolve()</code> 时，Promise 的状态变为 &quot;fulfilled&quot;（已完成）。</li>
<li><code v-pre>resolve()</code> 可以传递一个值，这个值会作为 <code v-pre>.then()</code> 方法中回调函数的参数。</li>
</ul>
</li>
<li>reject（拒绝）:
<ul>
<li>代表 Promise 失败或出错。</li>
<li>当调用 <code v-pre>reject()</code> 时，Promise 的状态变为 &quot;rejected&quot;（已拒绝）。</li>
<li><code v-pre>reject()</code> 通常传递一个错误对象，这个对象会作为 <code v-pre>.catch()</code> 方法中回调函数的参数。</li>
</ul>
</li>
</ul>
</div></template>
